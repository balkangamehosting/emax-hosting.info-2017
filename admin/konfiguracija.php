...
if(!defined('DBNAME')) define("DBNAME", 'zadmin_emax');
if(!defined('DBUSER')) define("DBUSER", 'zadmin_emax'); 
if(!defined('DBPASS')) define("DBPASS", 'yzupu7a6u');
if(!defined('CHARSET')) define("CHARSET", 'utf8');
if(!defined('DOMEN')) define("DOMEN", 'http://emax-hosting.info/admin/');
