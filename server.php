		...
		<tr>
			<td>
				...
				<div id="infos">
					...
					<p id="h2"><i class="icon-bar-chart"></i> <?php echo $jezik['text386']; ?>: <a target="_BLANK" href="http://e-max.xyz/grafik/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png"><z style="font-size: 9px;">http://e-max.xyz/grafik/<?php echo $boxip['ip'].'_'.$server['port']; ?>.png</z></a></p>
				</div>							
			</td>
...
?>
		...
		<?php 	if($server['igra'] == "1" OR $server['igra'] == "2" OR $server['igra'] == "3") { ?>
				<div id="infod" style="padding-bottom: 5px;">
					...
					<p id="h2"><i class="icon-bar-chart"></i> <?php echo $jezik['text386']; ?>: <a target="_BLANK" href="http://e-max.xyz/banner/<?php echo $boxip['ip'].':'.$server['port']; ?>.png"><z style="font-size: 9px;">http://e-max.xyz/banner/<?php echo $boxip['ip'].':'.$server['port']; ?>.png</z></a></p>
				</div><?php } ?><br />
