...
<head>
    ...
    <title><?php if(!empty($naslov)) echo $naslov; else echo 'Klijent'; ?> :: Insomnia Hosting</title>
                                    ...
                                    <div id="freq<?php echo $row['id']; ?>" style="cursor: default;" <?php if($row['status']==1) echo ' class="unread"'; ?>>
                                        <li>
                                            <table>
                                                <tr valign="top">
                                                    <td width="55">
                                                        <img style="margin: -8px;" width="55" height="55" src="avatar.php?mode=c&id=<?php echo $row['user_one']; ?>" />
                                                    </td>
                                                    <td>
...
?>
    ...
    ?>
                        <a href="http://46.105.77.179/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=en">
    ...
    <?php
                        ...
                        <a href="http://46.105.77.179/<?php echo "{$fajlxx}?{$_SERVER['QUERY_STRING']}"; ?>&jezik=sr">
