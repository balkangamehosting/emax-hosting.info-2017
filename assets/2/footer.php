					...
					<table style="width: 100%; vertical-align: top; border-spacing: 0px;">
						...
						<tr>
							...
							<td>
								...
								<div>
									<div class="fb-like-box" data-href="https://www.facebook.com/Insomnia-Hosting-1408688965885501" data-width="230" data-height="40" data-colorscheme="dark" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
								</div>
							</td>
							<td style="border-right: none">
								...
								<div id="footerlinks" class="test2">
									<ul>
										<li style="margin-left: -5px;"><div id="footerik2"></div><a href="mailto:support@insomnia-hosting.info">Email - support@insomnia-hosting.inf</a></li>
										<li style="margin-left: -5px;"><div id="footerik3"></div><a href="https://www.facebook.com/Insomnia-Hosting-1408688965885501">Facebook Stranica</a></li>
...
?>					
					<div id="copy">
						<p>
						<span style="float: left; text-align: left; width: 70%;">© INSOMNIA HOSTING SOLUTION All rights reserved.</span> <span style="float: left; width: 29%; text-align: right;">Stranica učitana za: <a><?php echo $pageload; ?>s</a> | Verzija: <?php echo $verzija['value']; ?></a></span>
						</p>
					</div>
				</div>   	
		</footer>
		...
		<form class="modal-uplata" id="modal-uplata">
			...
			<div style="padding: 7px;" id="hpromeni">
					...
					<table width="100%">
						<tr style="vertical-align: top;">
							<td>
								...
								Svrha uplate: <z>Insomnia Hosting</z><br />
				...
				<div id="narcg" style="display: none;">
					...
					* Kliknite na sliku za veci primerak.<br /><br />
					<z>UPUSTVA:</z><br />
					Da bi zakupili server prvo morate imati novca na insomnia računu. <br />To radite tako što uplatite sumu koju želite ( prvo pogledati cene servera kojeg hoćete uplatiti pa onda uplatite toliko novca, a možete i više ). Kada uplatite u pošti ili banci, slikajte uplatnicu sa pečatom koju ćete dobiti nakon uplate ( pečat i popunjene podatke moraju da se vide dobro ) prebaciti na kompjuter i uploadujte na nekom image upload sajtu. <br />Nakon toga možete nastaviti ove korake i čim administracija prihvati vašu uplatu, novac se prebacuje na vašem nalogu i vi možete zakupiti server.
