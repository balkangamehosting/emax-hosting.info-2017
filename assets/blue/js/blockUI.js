...
"use strict";
	...
	function setup($) {
		...
		$.poruka = function(title, message, timeout, onClose) {
			var $m = $('<div class="growlUI"></div>');
			if (message) $m.append('<p id="h6">'+message+'</p>');
		...
		$.blockUI.defaults = {
			...
			// styles applied when using $poruka
			growlCSS: {
				width:		'100%',
				top:		'0',
				left:		'0',
				...
				cursor:		'default',
				color:		'#fff',
				'background-image':'url("./assets/blue/img/alert.png")',
