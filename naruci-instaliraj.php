...
?>
				...
				<form action="process.php" method="POST"><br />
					...
					<?php echo $jezik['text509']; ?>: <z><?php echo $srv['slotovi']; ?></z> // 
					<?php echo $jezik['text510']; ?>: <z><?php echo $port; ?></z> // 
					<?php echo $jezik['text511']; ?>: <z><?php echo $srv['meseci']; ?></z>
					<table width="100%">
						<tr>
							<th width="50%"></th>
							<th width="50%"></th>
...
?>
						...
						<tr>
							<td>
								<input name="headuser" type="text" class="input" id="ki" placeholder="Pera" />
								<label id="titlex">
								*<?php echo $jezik['text514']; ?>
								</label>   						
							</td>					
							<td>
								<input name="headpass" type="password" class="input" id="lok" placeholder="Password" />
								<label id="titlex">
								*<?php echo $jezik['text515']; ?>
								</label>   						
							</td>
						</tr>	
						<tr>
